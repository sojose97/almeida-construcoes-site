...
async function changeStatus(orderId,status){
  ...
  try{
    await request("/rest/v1/rpc/admin_set_order_status_v2",{method:"POST",headers,body});
  }catch(error){
    ...
    try{
      await request("/rest/v1/rpc/admin_set_order_status",{method:"POST",headers,body});
    }catch(fallbackError){
