const CACHE='almeida-catalogo-v17';
const FILES=['./','index.html','produto.html','style.css','site.js','produto.js','image-cleanup.js','product-images.js','catalogo.js','supabase-config.js','assets/logo.jpg','assets/fachada-almeida.png'];
